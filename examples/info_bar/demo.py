...
class Demo(QWidget):
    ...
    def __init__(self):
        ...
        self.button0 = OutlinedPushButton('Snack', self)
        self.button1 = OutlinedPushButton('Information', self)
        self.button2 = OutlinedPushButton('Success', self)
        self.button3 = OutlinedPushButton('Warning', self)
        self.button4 = OutlinedPushButton('Error', self)
        self.button5 = OutlinedPushButton('Custom', self)

        self.button0.clicked.connect(self.createSnackInfoBar)
        ...
        self.hBoxLayout.addWidget(self.button0)
    ...
    def createInfoInfoBar(self):
        ...
        w.addWidget(TextPushButton('Action'))
        w.show()
